...
func TestCommandSurface(t *testing.T) {
	...
	for _, command := range []string{"bootstrap", "setup", "vpn", "direct", "status", "report", "logs", "info", "qr", "update", "restore-network", "uninstall", "direct-add", "direct-remove", "direct-list", "direct-edit", "ru", "foreign", "wifi"} {
