...
func TestCommandSurface(t *testing.T) {
	...
	for _, command := range []string{"bootstrap", "setup", "tunnel", "selective", "direct", "status", "report", "logs", "info", "qr", "update", "restore-network", "uninstall", "direct-add", "direct-remove", "direct-list", "direct-edit", "proxy-add", "proxy-remove", "proxy-list", "proxy-edit", "ru", "foreign", "wifi"} {
